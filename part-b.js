...
function isMemberRole(u) {
  return roleKey(u) === "member";
}
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(
          "p",
          { className: "text-xs text-slate-400" },
          "מסור אותה למשתמש והמלץ לו להחליף אותה. אם המשתמש נמחק בעבר ואתה מוסיף אותו שוב עם אותו אימייל, הוא יחזור עם הסיסמה החדשה שהזנת.",
        ),
      ),
      e.createElement(
        "div",
      ...
      queued &&
        e.createElement(
          ...
          e.createElement(
            ...
            `${s.trim()} כבר היה רשום בעבר. הוא יחזור לרשימה אוטומטית, עם הפרטים והסיסמה שהזנת כאן. זה יכול לקחת עד כמה שעות, ואין צורך לעשות שום דבר נוסף.`,
          ),
          e.createElement(
            "button",
        ...
        "button",
        {
          ...
          onClick: async () => {
            ...
            try {
              ...
              // הפרטים והסיסמה שהוזנו כאן — הכלי מאתר את החשבון לפי האימייל.
              if (
                ...
                try {
                  await V(M(P, "adminTasks"), {
                    ...
                    role: x,
                    phone: normalizePhone(m.trim()),
                    // הסיסמה החדשה נמחקת מהבקשה מיד אחרי שהכלי בענן מגדיר אותה
                    password: c,
                    status: "pending",
