      ...
      e.createElement(
        ...
        e.createElement(
          ...
          t.map((r) =>
            e.createElement("option", { key: r.id, value: r.id }, r.name),
          ),
        ),
      ),
      e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(
          "label",
          { className: "text-xs text-slate-500" },
          "\u05D8\u05DC\u05E4\u05D5\u05DF \u05D4\u05D5\u05E8\u05D4 (\u05D1\u05E4\u05D5\u05E8\u05DE\u05D8 9725XXXXXXXX)",
        ),
        e.createElement("input", {
          value: o,
        ...
        return e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(
              "button",
              {
                ...
                disabled: !u,
                className: `px-3 py-2 rounded-lg text-xs font-semibold border transition-colors ${w === "Present" ? "bg-emerald-500 text-white border-emerald-500" : "bg-white text-slate-400 border-slate-200"} ${u ? "active:scale-95" : "opacity-70"}`,
              },
              "\u05D4\u05D2\u05D9\u05E2",
            ),
            e.createElement(
              "button",
              {
                ...
                disabled: !u,
                className: `px-3 py-2 rounded-lg text-xs font-semibold border transition-colors ${w === "Absent" ? "bg-red-500 text-white border-red-500" : "bg-white text-slate-400 border-slate-200"} ${u ? "active:scale-95" : "opacity-70"}`,
              },
              "\u05DC\u05D0 \u05D4\u05D2\u05D9\u05E2",
            ),
          ),
          k &&
            e.createElement(Re, {
              ...
              onOpenWhatsapp: (v) =>
                window.open(
                  ne(v.parentPhone, Ve(v.parentName, v.name)),
                  "_blank",
                ),
            }),
          c &&
...
function mt({ profile: t, groups: s, players: a, attendance: l, isAdmin: i }) {
...
function Q() {
  ...
  return e.createElement(
    ...
    e.createElement(
      ...
      r && m === "phonebook" && e.createElement(lt, { players: c, groups: i }),
      r &&
        m === "reports" &&
      ...
      u && e.createElement(at, { groups: i, onClose: () => f(!1) }),
    ),
  );
}
